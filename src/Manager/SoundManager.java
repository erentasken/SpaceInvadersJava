...
public class SoundManager {
	...
	private AudioInputStream audioStream6;
	...
	public SoundManager() {
        ...
        gameSoundURL = getClass().getResource("/resources/sounds/hitSoundV2.wav");
        try {
        	audioStream6 = AudioSystem.getAudioInputStream(gameSoundURL);
            clip7 = AudioSystem.getClip();
            clip7.open(audioStream6);
        } catch (UnsupportedAudioFileException | IOException | LineUnavailableException e) {
            e.printStackTrace();
        }
    }
	
	public void damageTakenV2() {
